...
{
    /// <inheritdoc />
    public partial class addStatusAttr : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Nom = table.Column<string>(type: "text", nullable: false),
                    CoursLigneGroupe = table.Column<double>(type: "double precision", nullable: false),
                    CoursLigneIndividuel = table.Column<double>(type: "double precision", nullable: false),
                    CoursDomicileGroupe = table.Column<double>(type: "double precision", nullable: false),
                    CoursDomicileIndividuel = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specialities_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Niveaux = table.Column<int[]>(type: "integer[]", nullable: false),
                    Methodes = table.Column<int[]>(type: "integer[]", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specialities_ServiceId",
                table: "Specialities",
                column: "ServiceId");
