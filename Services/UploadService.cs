...
namespace Services
{
	public class UploadService
	{
		...
		public async Task<FileUploadResponseDTO> UploadFile(IFormFile file)
		{
			...
			{ // code -1 failure
				return new FileUploadResponseDTO { Msg = "No file uploaded or file is empty.", FileName = null , Code=-1};
			}
			...
			// code 1 = success
			return new FileUploadResponseDTO { Msg = "success", FileName = newFileName , Code=1};
